...
/******************************************************************************/
//#define L3GD20_WHO_AM_I_ADDR          0xD7  /* device identification register */
...
#define I_AM_L3GD20		    ((uint8_t)0xD7)
...
/** @defgroup STM32F3_DISCOVERY_L3GD20_Exported_Macros
  * @{
  */
#define L3GD20_CS_LOW()       GPIO_ResetBits(GPIOA, GPIO_Pin_15)//GPIO_ResetBits(L3GD20_SPI_CS_GPIO_PORT, L3GD20_SPI_CS_PIN)
#define L3GD20_CS_HIGH()      GPIO_SetBits(GPIOA, GPIO_Pin_15)//GPIO_SetBits(L3GD20_SPI_CS_GPIO_PORT, L3GD20_SPI_CS_PIN)
/**
  * @}
  */
