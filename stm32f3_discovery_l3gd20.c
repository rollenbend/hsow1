...
//  RCC_AHBPeriphClockCmd(L3GD20_SPI_INT2_GPIO_CLK, ENABLE);
  ...
  GPIO_InitStructure.GPIO_Pin = L3GD20_SPI_SCK_PIN; //GPIO_Pin_5
  GPIO_Init(GPIOA, &GPIO_InitStructure);

  /* SPI  MOSI pin configuration */
  GPIO_InitStructure.GPIO_Pin =  L3GD20_SPI_MOSI_PIN; //GPIO_Pin_7
  GPIO_Init(GPIOA, &GPIO_InitStructure);

  /* SPI MISO pin configuration */
  GPIO_InitStructure.GPIO_Pin = L3GD20_SPI_MISO_PIN; //GPIO_Pin_6
  GPIO_Init(GPIOA, &GPIO_InitStructure);

  GPIO_PinAFConfig(GPIOA, GPIO_PinSource5, GPIO_AF_5); // SPI_SCK
  GPIO_PinAFConfig(GPIOA, GPIO_PinSource6, GPIO_AF_5); // SPI_MISO
  GPIO_PinAFConfig(GPIOA, GPIO_PinSource7, GPIO_AF_5); // SPI_MOSI
