...
void LSM303DLHC_AccFilterConfig(LSM303DLHCAcc_FilterConfigTypeDef *LSM303DLHC_FilterStruct) 
{
  ...
  tmpreg |= (uint8_t) (LSM303DLHC_FilterStruct->HighPassFilter_Mode_Selection |\
                      LSM303DLHC_FilterStruct->HighPassFilter_CutOff_Frequency|\
											LSM303DLHC_FilterStruct->HighPassFilter_FDS|\
...
{  
  ...
  I2C_TransferHandling(I2C2, DeviceAddr, 1, I2C_Reload_Mode, I2C_Generate_Start_Write);
  ...
  /* Configure slave address, nbytes, reload, end mode and start or stop generation */
  I2C_TransferHandling(I2C2, DeviceAddr, 1, I2C_AutoEnd_Mode, I2C_No_StartStop);
...
//  EXTI_Init(&EXTI_InitStructure);
  ...
  I2C2_InitStructure.I2C_AnalogFilter = I2C_AnalogFilter_Enable;
  I2C2_InitStructure.I2C_DigitalFilter = 0x00;
  ...
  I2C2_InitStructure.I2C_Timing = 0x00000100;
